...
<div class="cart-section">
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{ route('profile.cart.clear') }}" class="btn btn-black">
                <i class="fas fa-trash-alt mr-2"></i>
                Clear
            </a>
        </div>
        <div class="cart-produc-bar w-100">
            <div class="container">
            @include('includes.flash.error')
            @include('includes.flash.success')
            <div class="form-row cart-nav-bar text-white text-center rounded ">
        ...
        <div class="col-md-12 py-2 justify-content-end">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('profile.cart.checkout') }}" class="btn btn-black">
