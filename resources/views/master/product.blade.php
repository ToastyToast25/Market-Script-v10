            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <table class="table border-0 text-left table-borderless">
                        ...
                        <tr>
                            <td class=" text-muted">Quality rate:</td>
                            <td>
                        ...
                        <tr>
                            <td class=" text-muted">Left/Sold</td>
                            <td>
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                <div class="col-md-12 mb-3">
                                    <input  class="w-100" type="number" min="1" name="amount" id="amount"
                                           value="1"
