...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <h3 class="mb-2 tickets-title">Tickets</h3>

            <a href="{{ route('profile.tickets') }}" class="btn  ticket-btn btn-block @if($ticket) btn-outline-primary @else btn-primary @endif my-2">
