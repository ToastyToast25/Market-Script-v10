...
//        'multisig' => 'Multisignature',
    ...
    {
        return $this -> hasOne(\App\Models\Offer::class, 'id', 'offer_id');
    }
    ...
    {
        return $this -> hasOne(\App\Models\Shipping::class, 'id', 'shipping_id');
    }
    ...
    {
        return $this -> hasOne(\App\Models\User::class, 'id', 'buyer_id');
    }
    ...
    {
        return $this -> hasOne(\App\Models\Dispute::class, 'id', 'dispute_id');
    }
    ...
    {
        return $this -> hasOne(\App\Models\Feedback::class, 'id', 'feedback_id');
    }
