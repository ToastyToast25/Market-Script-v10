...
class Product extends Model
{
    ...
    public function physical() {
        return $this->hasOne(\App\Models\PhysicalProduct::class, 'id', 'id');
    }
    ...
    public function offers() {
        return $this->hasMany(\App\Models\Offer::class, 'product_id', 'id')
    ...
    public function feedback() {
        return $this->hasMany(\App\Models\Feedback::class, 'product_id', 'id');
    }
