...
class User extends Authenticatable {
    ...
    public function products() {
        return $this->hasMany(\App\Models\Product::class, 'user_id')->where('active', true)->orderByDesc('created_at');
    }
    ...
    public function purchases() {
        return $this->hasMany(\App\Models\Purchase::class, 'buyer_id', 'id');
    }
    ...
    public function sales() {
        return $this->hasMany(\App\Models\Purchase::class, 'vendor_id', 'id');
    }
    ...
    public function receiverconversations() {
        return $this->hasMany(\App\Models\Conversation::class, 'receiver_id', 'id');
    }
...
//            }
    ...
    public function vendorPurchases() {
        return $this->hasMany(\App\Models\VendorPurchase::class, 'user_id', 'id');
    }
    ...
    public function referredBy() {
        return $this->hasOne(\App\Models\User::class, 'id', 'referred_by');
    }
    ...
    public function permissions() {
        return $this->hasMany(\App\Models\Permission::class, 'user_id', 'id');
    }
