...
//        if (!auth()->user()->hasPGP()) {
//            throw new RequestException("You don't has PGP Key set yet please add and checkout again ");
//        }
...
// $this->payment = app()->makeWith(\App\Marketplace\Payment\Payment::class, ['purchase' => $this->purchase]);
