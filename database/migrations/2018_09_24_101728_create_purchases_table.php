...
class CreatePurchasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table -> text('message');
            $table -> enum('state', array_keys(\App\Models\Purchase::$states)) ->default(\App\Models\Purchase::DEFAULT_STATE);
            $table -> enum('type', array_keys(\App\Models\Purchase::$types)) ->default(\App\Models\Purchase::DEFAULT_TYPE);
