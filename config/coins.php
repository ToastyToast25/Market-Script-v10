...
//        'xvg' => \App\Marketplace\Payment\VergeCoin::class,
    ...
    'monero' => [
        ...
        'port' => intval(env('MONERO_PORT',28081)),
    ...
    'market_addresses' => [
        'btc' => [ // list of btc addresses
            '3BYHj2Jj8tfjfBnDKhxp6CvAuKYPMmkoqM'
        ],
        'pivx' => [ // list of pivx addresses
            'xyQ7EsNzUUBMwyihUwgQ76E2Ac7FevEcQ4'
        ],
        'monero' => [
            '4GwH3RADAb4A6pTDa7q7GVCBRqqNgEmpkXHnhyhDjfwnZkkXcvHbmxzAS2kPg5L4Sz9ehb5sHhuWFZBkdpadxfmgHD3a2YLXL4M4B7WYrv'
        ],
        'xmr' => [
            '4GwH3RADAb4A6pTDa7q7GVCBRqqNgEmpkXHnhyhDjfwnZkkXcvHbmxzAS2kPg5L4Sz9ehb5sHhuWFZBkdpadxfmgHD3a2YLXL4M4B7WYrv'
        ],
